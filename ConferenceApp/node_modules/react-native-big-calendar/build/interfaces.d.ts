...
export type HeaderRenderer<T extends ICalendarEventBase> = React.JSXElementConstructor<CalendarHeaderProps<T> & {
    mode: Mode;
}>;
export type MonthHeaderRenderer = React.JSXElementConstructor<CalendarHeaderForMonthViewProps>;
export type HourRenderer = React.JSXElementConstructor<{
    ampm: boolean;
    hour: number;
}>;
